...
export const renderRestaurantDetails = (x, y, restaurant) => {
  ...
  const highlights = restaurant.highlights.map(el =>
    translateRestaurantHighlightsToPolish(el)
  );
  ...
  elements.restaurantDetails.innerHTML = `
        <div class="restaurant-details__info">
            ...
            <div class="restaurant-details__highlights">${highlights
              .map(
                el => `
...
export const hideRestaurantDetails = () => {
  ...
  setTimeout(
    () => elements.restaurantDetails.classList.remove('active', 'hide'),
    500
  );
